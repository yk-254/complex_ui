...
class AnimatedSwitchPlane extends StatefulWidget {
  const AnimatedSwitchPlane({Key? key}) : super(key: key);

  @override
  _AnimatedSwitchPlaneState createState() => _AnimatedSwitchPlaneState();
}

class _AnimatedSwitchPlaneState extends State<AnimatedSwitchPlane> {
  int pageNumber = 1;
