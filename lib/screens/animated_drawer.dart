          ...
          Flexible(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 60),
                  Text("Header", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
                  SizedBox(height: 20),
                  Divider(),
        ...
        child: Scaffold(
          ...
          body: Container(
            decoration: const BoxDecoration(
              ...
              gradient: LinearGradient(colors: [Colors.blueAccent, Colors.redAccent], begin: Alignment.topLeft),
            ),
            child: const Center(
              child: Text("test App", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
            ),
          ),
        ),
      ),
